...
..  literalinclude:: code/saleor/saleor/graphql/order/mutations/orders.py
    :language: python
    :linenos:
...
..  literalinclude:: code/saleor/saleor/core/permissions.py
    :language: python
    :linenos:
...
..  literalinclude:: code/saleor/saleor/graphql/api.py
    :language: python
    :linenos:
